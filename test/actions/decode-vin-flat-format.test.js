...
import decodeVinFlatFormatSuccessJSON from '../mocked-responses/decode-vin-flat-format/success';
...
describe('#decodeVinFlatFormat()', () => {
  ...
  beforeEach(() => {
    ...
    const resolved = Promise.resolve(decodeVinFlatFormatSuccessJSON);
